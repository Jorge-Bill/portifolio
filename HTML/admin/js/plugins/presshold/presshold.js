...
;(function($, window, document, undefined) {
	...
	Plugin.prototype = {
		init: function() {
			...
			progressIndicatorHTML = '<div class="holdButtonProgress" style="height: 0%; width: 0%; position: absolute; top: 0; left: -100%; background-color:' + this.settings.progressIndicatorColor + '; opacity:' + this.settings.progressIndicatorOpacity + ';"></div>';
