...
(function (factory) {
    ...
    lang: {
      'en-US': {
        ...
        image: {
          ...
          resizeFull: 'Tamanho real',
          resizeHalf: 'Metade do tamanho',
          resizeQuarter: '1/4 do tamanho',
          floatLeft: 'Alinhar a esquerda',
          floatRight: 'Alinhar a direita',
          floatNone: 'Sem alinhamento',
          shapeRounded: 'Bordas redondas',
          shapeCircle: 'Em circulo',
          shapeThumbnail: 'Bordas Largas',
          shapeNone: 'Sem Borda',
          dragImageHere: 'Araste e solte uma imagem ou texto aqui',
          dropImage: 'Araste e solte uma imagem ou texto aqui',
          selectFromFiles: 'Selecionar das pastas',
          maximumFileSize: 'Tamanho maximo',
          maximumFileSizeError: 'Tamanho maximo excedido',
  ...
  var Renderer = function () {
    ...
    var representShortcut = function (str) {
      if (agent.isMac) {
        str = str.replace('CMD', 'CMD').replace('SHIFT', 'SHIFT');
      }
